 ...
 */
	public function admin_add() {
		if ($this->request->is('post')) {
			$this->Coupon->create();
            $this->request->data['Coupon']['time_start'] = strtotime($this->request->data['Coupon']['time_start']);
            $this->request->data['Coupon']['time_end'] = strtotime($this->request->data['Coupon']['time_end']);
