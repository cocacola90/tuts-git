<div class="giftcards index">
	...
	<tr>
		...
		<td><?php echo h($giftcard['Giftcard']['code']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($giftcard['User']['id'], array('controller' => 'users', 'action' => 'view', $giftcard['User']['id'])); ?>
		</td>
		<td><?php echo h($giftcard['Giftcard']['used']); ?>&nbsp;</td>
		<td><?php echo h($giftcard['Giftcard']['created']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $giftcard['Giftcard']['id']), array(), __('Are you sure you want to delete # %s?', $giftcard['Giftcard']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
