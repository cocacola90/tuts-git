...
<body>
	...
	<div id="print_head" style="border-bottom:#ccc solid 1px; height:60px; padding-bottom:10px;">
		<div class="logo" style="width:200px; height:60px; background:url(http://dx.nguyenpham.info/theme/Volga/images/logo.png) 10px 0 no-repeat; float:left;">
			<a href="/" style="width:120px; height:60px; display:block; cursor:pointer;"></a>
		</div>

		<div class="address" style="float:left; width:590px; padding:10px 0 0 15px;">
			-- Dia chi cua hang --
			<br>
			TEL: xxxx-xxx-xxx
		</div>
			...
			<div class="print_box_con" style="width:760px; height:auto; margin:0 auto; overflow:hidden; border-top:#ddd solid 1px;" style="text-align:left; padding-bottom:10px;">
				<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center"
					...
					<tr>
						...
						<?php echo $currency_detail['Country']['prefix'] . number_format(($item['OrdersProduct']['price'] * $currency_detail['Country']['rate']),2);?>
						</td>
						<td field="Quantity"><?php echo $item['OrdersProduct']['quantity'];?></td>
						<td field="Total" style="font-size:12px; padding:2px 0;}">
						<?php echo $currency_detail['Country']['prefix'] . number_format(($item['OrdersProduct']['price'] * $currency_detail['Country']['rate']) * $item['OrdersProduct']['quantity'],2) ;?>
						</td>
					</tr>
					<?php endforeach;?>
					</tbody>
			...
			<div class="print_box_con">
				<div class="print_box_price" style="width:243px; height:auto; overflow:hidden; float:right; padding:10px;">
					<dl style="width:243px; height:auto;overflow:hidden;">
						...
						<?php echo $currency_detail['Country']['prefix'];?> <?php echo number_format(($order['Order']['shipping_cost']),2);?>
						</span>
					</dl>
					<dl>
						<dt>Coupon saving:</dt>
