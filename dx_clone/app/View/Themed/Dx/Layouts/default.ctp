...
<head>
    ...
    <title><?php echo $title_for_layout;?> - Demo</title>
    ...
    <!-- Bootstrap -->
    <?php echo $this->Html->css(array('bootstrap.min','style','cart_style','animate','style-slider','flexslider','JRating.jquery','page','lightbox'));?>
    ...
    <?php echo $this->Html->script(array('wow.min','bootstrap.min','shipping_cost','accounting.min','jquery.flexslider','jquery.flexisel', 'JRating.jquery','jcarousellite_1.0.1','lightbox', 'scripts'));?>
...
<?php echo $this->element('banner_wrapper');?>
