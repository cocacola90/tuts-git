...
<head>
	...
	<!-- End CSS -->
	<?php echo $this->Html->script(array('jquery-1.7.2.min', 'jquery.flexslider', 'jcarousellite_1.0.1', 'lightbox', 'tooltip', 'jquery.flexisel','shipping_cost','angular.min','accounting.min')); ?>
	<!-- End JAVASCRIPT -->
