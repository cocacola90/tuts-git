...
<html lang="en">
	<head>
		...
		<!--[if IE]>
		<script type="text/javascript">
		 	window.jQuery || document.write("<?php echo $this->Html->script('jquery1x.min'); ?>");
		</script>
<![endif]-->
	</head>
	...
	<body class="no-skin">
					...
					<ul class="nav ace-nav">
									...
									<ul class="dropdown-menu dropdown-navbar">
										<li>
											<a href="#" class="clearfix">
												<?php echo $this->Html->image('/avatars/avatar.png', array('class' => 'msg-photo')); ?> 
												<span class="msg-body">
										...
										<li>
											<a href="#" class="clearfix">
												<?php echo $this->Html->image('/avatars/avatar3.png', array('class' => 'msg-photo')); ?> 
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<?php echo $this->Html->image('/avatars/avatar4.png', array('class' => 'msg-photo')); ?> 
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<?php echo $this->Html->image('/avatars/avatar2.png', array('class' => 'msg-photo')); ?> 
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<?php echo $this->Html->image('/avatars/avatar5.png', array('class' => 'msg-photo')); ?> 
												<span class="msg-body">
													<span class="msg-title">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<?php echo $this->Html->image('/avatars/user.png', array('class' => 'nav-user-photo')); ?>
		...
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='/theme/Admin/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
		<?php echo $this->Html->script('bootstrap.min'); ?>
		<!-- page specific plugin scripts -->
		<?php echo $this->Html->script('jquery.dataTables.min'); ?>
		<?php echo $this->Html->script('jquery.dataTables.bootstrap.min'); ?>
		<!-- ace scripts -->
		...
		<?php echo $this->Html->script('chosen.jquery.min'); ?>
		        <?php echo $this->Html->script('daterangepicker.min'); ?>
