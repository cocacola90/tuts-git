        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    "regex": "none",
                    "alertText": "* Vui lòng nhập thông tin ở đây",
                    "alertTextCheckboxMultiple": "* Vui lòng chọn một lựa chọn",
                    "alertTextCheckboxe": "* Bạn phải đồng ý thì mới đăng ký được.",
                ...
                "minSize": {
                    "regex": "none",
                    "alertText": "* Yêu cầu ít nhất ",
                    "alertText2": " ký tự"
                },
                "maxSize": {
                    "regex": "none",
                    "alertText": "* Yêu cầu nhiều nhất ",
                    "alertText2": " ký tự"
                },
				"groupRequired": {
                    "regex": "none",
				...
				"sochan":{
					"func": function(field, rules, i, options){
                        return (field.val() % 2 == 0) ? true : false;
                    },
                    "alertText": "* Giá trị của trường phải là số chẵn"
				},
                "number": {
				...
				"ajaxCheckAccountPhp": {
                    "url": "transactiondemos/checkacc",
                    // you may want to pass extra data on the ajax call
                    "extraData": "name=eric",
                    // if you provide an "alertTextOk", it will show as a green prompt when the field validates
                    "alertTextOk": "* Nhân vật đã tồn tại",
                    "alertText": "* Bạn chưa tạo nhân vật tại Server này",
                    "alertTextLoad": "* Đang xác nhận, vui lòng chờ"
                },
                "ajaxNameCall": {
