        ...
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content">
					...
					<div class="form-group">
                        <label for="title">Shipping method:</label>
						<?php $ship_type = GlobalVar::read('ship_type')?>
                        <?php echo $this->Form->input('type', array('type' => 'select', 'options' => $ship_type,'class' => 'form-control', 'empty' => 'Chọn loại vận chuyển', 'label' => false, 'div' => false)); ?>
                    </div>
                    <div class="form-group">
