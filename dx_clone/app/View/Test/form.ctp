		...
		<div id="login-box" class="login-box visible widget-box no-border">
			<div class="widget-body">
				<div class="widget-main">
					...
					<div class="space-6"></div>
					<?php echo $this->Form->create('User',array('action'=>'login','inputDefauls'=>array('div' => false,'label' => false)));?>
		...
		<div id="signup-box" class="signup-box widget-box no-border">
			<div class="widget-body">
				<div class="widget-main">
					...
					<?php echo $this->Form->create('User',array('action'=>'register','inputDefauls'=>array('div' => false,'label' => false)));?>
						<fieldset>
							<label class="block clearfix">
								<span class="block input-icon input-icon-right">
							...
							<label class="block clearfix">
								<span class="block input-icon input-icon-right">
									<?php echo $this->Form->input('re_password',array('type' => 'password','class'=>'form-control','placeholder' => 'Repeat password'));?>
									<i class="ace-icon fa fa-retweet"></i>
								</span>
							</label>
							<label class="block clearfix">
								<span class="block input-icon input-icon-right">
									<?php echo $this->Form->input('firstname',array('type' => 'text','class'=>'form-control','placeholder' => 'First Name'));?>
									<i class="ace-icon fa fa-user"></i>
								</span>
							</label>
							<label class="block clearfix">
								<span class="block input-icon input-icon-right">
									<?php echo $this->Form->input('lastname',array('type' => 'text','class'=>'form-control','placeholder' => 'Last Name'));?>
									<i class="ace-icon fa fa-user"></i>
								</span>
							</label>
