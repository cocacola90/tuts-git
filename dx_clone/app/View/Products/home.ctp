...
if (isset($ban_chay)):
    ...
    <div class="mods">
    <div class="bghelper">
    <a href="/top-sellers.html"><h3>Best Sale</h3></a>
    <div class="modulcontent">
                            ...
                            <div class="add-to-cart-view-container">
                                ...
                                <div id="product-id-<?php echo $item['Product']['id'] ?>"
                                    ...
                                    <div class="addtocart-area ">
                                        <?php echo $this->Form->create('Product', array('class' => 'product js-recalculate', 'id' => "bc-addCartForm-{$item['Product']['id']}")) ?>
                                        ...
                                        <div class="addtocart-bar">
                                            ...
                                            <a id="submit-<?php echo $item['Product']['id']; ?>"
                                               ...
                                               onClick="addCart('<?php echo $item['Product']['id']; ?>','bc-');">Submit</a>
...
<?php if (isset($quan_tam)): ?>
    ...
    <div class="mods">
    <div class="bghelper">
    <a href="/featured-items.html"><h3>Featured Items</h3></a>
...
<?php if (isset($product_new)): ?>
    <div class="content-top-mods second row-fluid">
    <div class="moduletable span12">
    <div class="mods">
    <div class="bghelper">
	<a href="/new-arrivals.html"><h3>Lastest Items</h3></a>
    <div class="modulcontent">
    <div id="product-list" class="vm-product-module">
    <div class="vm-product-module product-listing">
    <?php
    ...
    foreach ($product_new as $item):
		...
		//pr($values);
        foreach ($values as $value) {
            $arr1[$item['Product']['id']][$value['attribute_id']][$value['id']] = $value['name'];
        }
            ...
            <article class="spacer">
				...
				<?php if($item['Product']['publish'] == 1):?>
                    ...
                    <div id="product-id-<?php echo $item['Product']['id'] ?>"
                         class="add-to-cart-details-view hide">
                        <div class="addtocart-area ">
                            <?php echo $this->Form->create('Product', array('class' => 'product js-recalculate', 'id' => "new-addCartForm-{$item['Product']['id']}")) ?>
                            ...
                            <div class="product-fields">
                                <div class="product-field product-field-type-S">
                                    ...
                                    <div class="product-field-display">
                                        ...
                                        <?php foreach ($arr1[$item['Product']['id']][10] as $ky => $va): ?>
                                            <input id="<?php echo $ky; ?>" 
                                                   type="radio" value="<?php echo $ky; ?>"
                                                   name="pcolor"/>
                                            <label for="32" class="other-customfield">
                            ...
                            <div class="addtocart-bar">
                                ...
                                <a id="submit-<?php echo $item['Product']['id']; ?>"
                                   class="addtocart-button btn btn-inverse submit-<?php echo $item['Product']['id']; ?>"
                                   onClick="addCart('<?php echo $item['Product']['id']; ?>','new-');">Submit</a>
        ...
        $.ajax({
            ...
            success: function (msg_data) {
                ...
                if (obj.message === "ok") {
					...
					loi_sweet('Item added to cart!', 'success',5000);
                }
