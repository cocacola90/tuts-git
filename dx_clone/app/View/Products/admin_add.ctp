...
<?php echo $this->Form->create('Product', array('role' => 'form', 'class' => 'form-horizontal', 'inputDefaults' => array('label' => false, 'div' => false))); ?>
	<div class="tabbable">
		<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
			...
			<li>
				<a data-toggle="tab" href="#attribute_product">Thuộc tính sản phẩm</a>
			</li>
			<li>
                <a data-toggle="tab" href="#related_product">Sản phẩm liên quan</a>
            </li>
		...
		<div class="tab-content">
			<div id="info_product" class="tab-pane in active">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo $this->Form->input('Tag', array('class' => 'col-xs-10 col-sm-10','type'=>'text','data-role'=>'tagsinput')); ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<label>
							<?php echo $this->Form->checkbox('prominent', array('hiddenField' => false, 'class' => 'ace', 'checked' => true)); ?>
			...
			<div id="image_product" class="tab-pane">
				<div id="ajax_load_input">
					<div class="form-group">
						<label for="" class="col-sm-2 control-label no-padding-right">Ảnh 1:</label>
						<div class="col-sm-10">
							<input type="text" class="col-xs-7 col-sm-7" id="Image01" name="data[Image][image_more][]" />
					        <input type="button" value="Chọn..." onclick="LoiBrowseServer('Images:/', 'Image01');" class="col-xs-2 col-sm-2" />
					    </div>
					</div>
					<div class="form-group">
						<label for="" class="col-sm-2 control-label no-padding-right">Ảnh 2:</label>
					    <div class="col-sm-10">
							<input type="text" class="col-xs-7 col-sm-7" id="Image02" name="data[Image][image_more][]" />
					        <input type="button" value="Chọn..." onclick="LoiBrowseServer('Images:/', 'Image02');" class="col-xs-2 col-sm-2" />
					    </div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-3">
						...
						<div class="controls pull-right hidden-xs">
							<a class="left fa fa-chevron-left btn btn-success" href="#carousel-related"
							   data-slide="prev"></a><a class="right fa fa-chevron-right btn btn-success" href="#carousel-related"
														data-slide="next"></a>
						</div>
					</div>
				</div>
