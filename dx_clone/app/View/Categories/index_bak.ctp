...
<div id="breadcrumb">
    <ul>
        ...
        <li>»</li>
        <li><a href="/danh-muc/<?php echo $products[0]['Category']['slug']; ?>.html"><?php echo $products[0]['Category']['name']; ?></a></li>

    </ul>
</div>

<!--<div id="loi_left" style="width: 270px; float: left">
	<?php echo $this->element('search_conditions'); ?>
</div>-->

<div id="loi_right" style="float: right">
    <?php
		$stt = 0;
		if(!empty($products)):
