...
<div class="form-group" id="select_type">
    ...
    <div class="col-sm-10">
        ...
        <?php echo $this->Form->input('type', array('class' => 'col-xs-10 col-sm-10','type'=>'select','options'=>$type_combo,'empty'=>'-- Chọn loại combo --','default' => $this->request->data['Combo']['type'])); ?>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
            ...
            var type = $("#ComboType option:selected").val();
            if(type == 1)
            {
                $( "#select_product" ).show();
            }else if(type == 2)
