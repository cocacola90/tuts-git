...
<div class="form-group" id="select_type">
    ...
    <div class="col-sm-10">
        <?php echo $this->Form->input('time_start',array('value' => date('m/d/Y',$this->request->data['Coupon']['time_start']),'class'=>'col-xs-5 col-sm-5 date-picker-start','id' =>'id-date-picker-1','type'=>'text','data-date-format'=>'mm/dd/yyyy'));?>
    </div>
</div>
<div class="form-group" id="select_type">
    ...
    <div class="col-sm-10">
        <?php echo $this->Form->input('time_end',array('value' => date('m/d/Y',$this->request->data['Coupon']['time_end']),'class'=>'col-xs-5 col-sm-5 date-picker-end','id' =>'id-date-picker-2','type'=>'text','data-date-format'=>'mm/dd/yyyy'));?>
    </div>
</div>
